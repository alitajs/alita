  ...
  return class Generator extends api.Generator {
    ...
    writing() {
      ...
      this.fs.copyTpl(
        ...
        join(paths.cwd, this.hasName ? this.appName : '', `src/pages/${fileName}/index.${jsxExt}`),
        context,
      );
      this.fs.copyTpl(
      ...
      this.fs.copyTpl(
        ...
        join(paths.cwd, this.hasName ? this.appName : '', `src/models/${fileName}.${jsExt}`),
        context,
      );
      this.fs.copyTpl(
      ...
      this.fs.copyTpl(
        ...
        join(paths.cwd, this.hasName ? this.appName : '', `src/services/api.${jsExt}`),
        context,
      );
      this.fs.copyTpl(
      ...
      if (isTypeScript) {
        this.fs.copyTpl(
          ...
          join(paths.cwd, this.hasName ? this.appName : '', 'src/models/connect.d.ts'),
          context,
        );
